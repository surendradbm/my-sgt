...
<div class="app-navbar flex-shrink-0">
	...
	<div class="app-navbar-item ms-5 ms-md-5" id="kt_header_user_menu_toggle">
		<!--begin::Menu wrapper-->
		<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" class="header-user-profile">
