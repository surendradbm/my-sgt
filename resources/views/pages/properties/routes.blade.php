    ...
    <section class="property-section">
        ...
        <div class="py-3 px-7">
            <ul class="breadcrumb">
                ...
                <li><i class="fas fa-chevron-right"></i></li>
                <li><a href="#">Create Checkpoints & Tasks</a></li>
                <li><i class="fas fa-chevron-right"></i></li>
                    ...
                    <div class="row mb-10">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Route Number" class="form-control mb-1">
                            </div> 
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-5">
                                <h1 class="title">Routes</h1>
                                <p class="text-black-50">Minimum 2 checkpoints need to be selected to create a route. <a href="#" class="link">+ Add more Checkpoint</a></p>
                            </div>
                                ...
                                <div class="card-body px-5">
                                    <ul class="route-checkpoint-list">
                                        ...
                                        <li>
                                            ...
                                            <div class="w-100">
                                                <select class="form-select">
                                                    <option value="Checkpoint 1">Checkpoint 2</option>
                                                </select>
                                            </div>
                                            <div>
                                        ...
                                        <li>
                                            ...
                                            <div class="w-100">
                                                <select class="form-select">
                                                    <option value="Checkpoint 1">Checkpoint 3</option>
                                                </select>
                                            </div>
                                            <div>
                                                <button><i class="fas fa-trash"></i></button>
                                        ...
                                        <li>
                                            ...
                                            <div class="w-100">
                                                <select class="form-select">
                                                    <option value="Checkpoint 1">Checkpoint 4</option>
                                                </select>
                                            </div>
                                            <div>
                                            </div>
