    ...
    <section class="property-section">
        ...
        <div class="py-3 px-7">
            <ul class="breadcrumb">
                ...
                <li><a href="#">Rivi properties</a></li>
                <li><i class="fas fa-chevron-right"></i></li>
                <li class="active"><a href="#">Property Shifts</a></li>
            </ul>
        </div>
        {{-- Breadcrumbs (End) --}}
