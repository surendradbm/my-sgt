    ...
    <section class="property-section">
        ...
        <div class="py-3 px-7">
            <ul class="breadcrumb">
                ...
                <li><i class="fas fa-chevron-right"></i></li>
                <li class="active"><a href="#">Create Checkpoints & Tasks</a></li>
            </ul>
        </div>
        {{-- Breadcrumbs (End) --}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-5">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter checkpoint name" class="form-control mb-1">
                            </div> 
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12 mb-4">
                            <div class="form-group">
                                ...
                                <p class="small text-black-50"><i>Checkpoint time should be between the shift time: 04:00 PM - 08:00PM</i></p>
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <p class="description small">(Enter checkpoint latitude and longitude for guards to reach checkpoints)</p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12 mb-5">
                            <div class="form-group">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 mt-4">
                            <figure class="overflow-hidden rounded">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d241317.1457143858!2d72.71637333457338!3d19.082177512678562!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c6306644edc1%3A0x5da4ed8f8d648c69!2sMumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1687857332610!5m2!1sen!2sin" class="w-100" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </figure>
                        </div>
                        ...
                        <div class="col-lg-4 col-12 mb-4">
                            ...
                            <p class="small text-dark"><i class="fas fa-info-circle me-2"></i>Scan the QR to clockin into the shift</p>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="task-list">
                            <div class="task row align-items-center justify-content-between">
                                <div class="col-lg-6">
                                    <div>
                                        <label class="mb-lg-0 mb-2">Task 7</label>
                            ...
                            <div class="task row align-items-center justify-content-between">
                                <div class="col-lg-6">
                                    <div>
                                        <label class="mb-lg-0 mb-2">Task 6</label>
                                        <input type="text" class="form-control" value="Check all security cameras">
                                    </div>
                                </div>
                                <div class="col-lg-1">
                                    <div class="text-end">
                            ...
                            <div class="task row align-items-center justify-content-between">
                                <div class="col-lg-6">
                                    <div>
                                        <label class="mb-lg-0 mb-2">Task 5</label>
                                        <input type="text" class="form-control" value="Check all security cameras">
                                    </div>
                                </div>
                                <div class="col-lg-1">
                            ...
                            <div class="task row align-items-center justify-content-between">
                                <div class="col-lg-6">
                                    <div>
                                        <label class="mb-lg-0 mb-2">Task 4</label>
                                        <input type="text" class="form-control" value="Check all security cameras">
                                    </div>
                                </div>
                                <div class="col-lg-1">
                            ...
                            <div class="task row align-items-center justify-content-between">
                                <div class="col-lg-6">
                                    <div>
                                        <label class="mb-lg-0 mb-2">Task 3</label>
                                        <input type="text" class="form-control" value="Check all security cameras">
                                    </div>
                                </div>
                                <div class="col-lg-1">
                            ...
                            <div class="task row align-items-center justify-content-between">
                                <div class="col-lg-6">
                                    <div>
                                        <label class="mb-lg-0 mb-2">Task 2</label>
                                        <input type="text" class="form-control" value="Check all security cameras">
                                    </div>
                                </div>
                                <div class="col-lg-1">
                            ...
                            <div class="task row align-items-center justify-content-between">
                                <div class="col-lg-6">
                                    <div>
                                        <label class="mb-lg-0 mb-2">Task 1</label>
                                        <input type="text" class="form-control" value="Check all security cameras">
                                    </div>
                                </div>
                                <div class="col-lg-1">
