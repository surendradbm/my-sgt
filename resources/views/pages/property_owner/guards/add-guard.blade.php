        ...
        <div class="p-7">
            ...
            <div class="card section-card add-guard-card mb-6">
                <div class="card-body p-7">
                    <div class="mb-10">
                        <img src="{{asset('assets/images/guards/guard-profile.png')}}" alt="guard-profile" class="guard-profile me-2">
                        ...
                        <div class="col-lg-3 col-md-6 col-12 mb-5">
                            <div>
                                <div class="drag-drop-input">
                                    <label>Drag Here <br>
                                        Or <span class="text-decoration-underline" style="color: #244B8A;">Upload</span></label>
                                    <input type="file" style="height: 200px" required>
                                </div>
                            </div>
                        </div>
