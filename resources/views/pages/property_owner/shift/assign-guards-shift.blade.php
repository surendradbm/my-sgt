    ...
    <section class="property-section">
        ...
        <div class="py-3 px-7">
            <ul class="breadcrumb">
                ...
                <li><i class="fas fa-chevron-right"></i></li>
                <li><a href="/shift/checkpoint/edit">Edit Checkpoints & Tasks</a></li>
                <li><i class="fas fa-chevron-right"></i></li>
                <li><a href="/shift/routes">Edit Routes</a></li>
                <li><i class="fas fa-chevron-right"></i></li>
                <li class="active"><a href="/shift/assign-guards">Assign Guards</a></li>
        ...
        <div class="p-7">
            ...
            <div class="card property-create-card">
                <div class="card-body p-5 text-end">
                    <button class="btn btn-primary inverse me-3">Edit</button>
