                ...
                <div class="card-body">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted"> > </li>
                            <li class="breadcrumb-item text-bg text-hover-primary">Support</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body py-5">
                        <div class="card-body">
                            <label class="form-label" for="maximum_property">
                                <h3><b><u>Support Details
                                    </b></u></h3>
                            </label><br>
                            <div class="row">
                                <div class="col-md-2 mt-5">
                                    <div class="form-group">
                                        <label class="required form-label" for="maximum_property">Support Number
                                            :</label>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-2 mt-5">
                                    <div class="form-group">
                                        <label class="required form-label" for="maximum_property">Toll Free Number
                                            :</label>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-solid"
                                            name="maximum_property" id="maximum_properties" aria-describedby="emailHelp"
                                            placeholder="Enter Toll Free Number" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2 mt-5">
                                    <div class="form-group">
                                        <label class="required form-label" for="maximum_property">Support Gmail
                                            :</label>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-solid"
                                            name="maximum_property" id="maximum_properties" aria-describedby="emailHelp"
                                            placeholder="Enter Support Gmail" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2 mt-5">
                                    <div class="form-group">
                                        <label class="required form-label" for="maximum_property">Default Sender Email Address
                                            :</label>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-solid"
                                            name="maximum_property" id="maximum_properties" aria-describedby="emailHelp"
                                            placeholder="Enter Default Sender Email Address" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2 mt-5">
                                    <div class="form-group">
                                        <label class="required form-label" for="maximum_property">Default Sender Full Name
                                            :</label>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-3">
                    ...
                    <div class="card-body py-5">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-2 mt-5">
                                    <div class="form-group">
                                        <label class="required form-label" for="maximum_property">Google Plus URL
                                            :</label>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-solid"
                                            name="maximum_property" id="maximum_properties" aria-describedby="emailHelp"
                                            placeholder="Enter Google Plus URL" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2 mt-5">
                                    <div class="form-group">
                                        <label class="required form-label" for="maximum_property">Facebook URL
                                            :</label>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-3">
                            ...
                            <div class="row">
                                <div class="col-md-2 mt-5">
                                    <div class="form-group">
                                        <label class="required form-label" for="maximum_property">Twitter URL
                                            :</label>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-3">
                            ...
                            <div class="row">
                                <div class="col-md-2 mt-5">
                                    <div class="form-group">
                                        <label class="required form-label" for="maximum_property">Pinterest URL
                                            :</label>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-solid"
                                            name="maximum_property" id="maximum_properties" aria-describedby="emailHelp"
                                            placeholder="Enter Pinterest URL" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2 mt-5">
                                    <div class="form-group">
                                        <label class="required form-label" for="maximum_property">Instagram URL
                                            :</label>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-3">
                            ...
                            <div class="row">
                                <div class="col-md-2 mt-5">
                                    <div class="form-group">
                                        <label class="required form-label" for="maximum_property">Youtube URL
                                            :</label>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-3">
