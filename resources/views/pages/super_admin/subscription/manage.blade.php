                ...
                <div class="card-body">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <h1 class="page-heading d-flex text-bg fw-bold fs-3 flex-column justify-content-center my-0">
                            {{__('messages.Manage_Subscription')}}</h1>
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            <li class="breadcrumb-item text-muted">
                                <a href="/" class="text-muted text-hover-primary">{{__('messages.Subscription')}}</a>
                            </li>
                            <li class="breadcrumb-item text-muted"> > </li>
                            <li class="breadcrumb-item text-bg">{{__('messages.Manage_Subscription')}}</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-hover display responsive table-rounded border gy-7 gs-7"
                                ...
                                <thead>
                                    <tr class="fw-semibold fs-6 border-bottom-2 border-gray-200">
                                        ...
                                        <th>{{__('messages.s_no')}}</th>
                                        <th>{{__('messages.Icon')}}</th>
                                        <th>{{__('messages.Title')}}</th>
                                        <th>{{__('messages.Monthly_Price')}}</th>
                                        <th>{{__('messages.Yearly_Price')}}</th>
                                        <th>{{__('messages.Trial_Days')}}</th>
                                        <th>{{__('messages.Created_By')}}</th>
                                        <th>{{__('messages.Creation_Date_&_Time')}}</th>
