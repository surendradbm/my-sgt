                ...
                <div class="card-body">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-bg">Edit Subscription</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12 d-flex flex-stack">
                            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                <h5
                                    ...
                                    Edit Subscription</h5>
                                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                    <li class="breadcrumb-item text-muted">
                                        <p class="text-muted">Fill out the necessary details to edit the Subscription
                                        </p>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="mb-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="title"
                                        ...
                                        placeholder="Enter subscription title" maxlength="42" required value="Silver">
                                </div>
                            </div>
                            <div class="mb-10">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control form-control-solid" name="description" id="kt_docs_maxlength_textarea"
                                        maxlength="120" placeholder="Enter Description" rows="6">gjihlkjl</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-flush shadow-sm mt-5">
                    <div class="card-body py-5">
                           <div class="row">
                            ...
                            <div class="col-md-6" id="hide_row" style='display:none;'>
                                <div class="form-group">
                                    <label for="trial_days" class="required form-label">Trial Days</label><br>
                                    <span id="trial_days_help" class="form-text text-muted">Enter yearly price days for the
                                        subscription</span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control form-control-solid"
                                            ...
                                            placeholder="Enter Monthly Price Days" required value="8">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <span id="trial_days_help" class="form-text text-muted">Enter yearly price
                                            ...
                                            subscription</span>
                                        <input type="number" class="form-control form-control-solid"
                                            name="yearly_price" value="12" id="yearly_price" 
                                            placeholder="Enter Yearly Price Days" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control form-control-solid"
                                        ...
                                        placeholder="Enter maximum property" required value="10">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control form-control-solid"
                                        ...
                                        placeholder="Enter maximum shift" required value="50">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6  mt-5">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control form-control-solid"
                                        ...
                                        placeholder="Enter maximum guards" required value="10">
                                </div>
                            </div>
                            <div class="col-md-6  mt-5">
                                <div class="form-group">
